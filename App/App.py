...
# sql connector
connection = pymysql.connect(host='localhost',port=3306,user='root',password='Kom@l234',db='cv')
...
def run():
    ...
    link = '<b>Built with 🤍 by <a style="text-decoration: none; color: #021659;">Komal Gupta</a></b>' 
    ...
    if choice == 'User':
        ...
        if pdf_file is not None:
            ...
            if resume_data:
                ...
                insert_data(str(sec_token), str(ip_add), (host_name), (dev_user), (os_name_ver), (latlong), (city), (state), (country), (act_name), (act_mail), (act_mob), resume_data['name'], resume_data['email'] if resume_data['email'] else "not_found@example.com"
, str(resume_score), timestamp, str(resume_data['no_of_pages']), reco_field, cand_level, str(resume_data['skills']), str(recommended_skills), str(rec_course), pdf_name)
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built with 🤍 by 
            <a href="https://www.linkedin.com/in/komalgupta8/" style="text-decoration: none; color: grey;">Komal Gupta</a> through 
        </p>
